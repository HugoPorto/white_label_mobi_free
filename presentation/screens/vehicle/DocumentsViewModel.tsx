...
export class DocumentsViewModel {
    ...
    // =============================================
    // UPDATE - Aprovar todos os documentos de um veículo (ADMIN)
    // =============================================
    async approveAllDocumentsByVehicle(
        idVehicle: number,
        reviewedBy: number,
        notes?: string
    ): Promise<{ approved: DocumentResponse[]; count: number } | ErrorResponse> {
        return await this.documentsService.approveAllByVehicle(idVehicle, reviewedBy, notes);
    }
