...
export function ClientTripHistoryItem({ clientRequestResponse, onCancel, onTravel, onRefresh, onFinish }: Props) {
    const [isReportModalVisible, setIsReportModalVisible] = useState(false);
    const [reportText, setReportText] = useState('');
    const [isRatingModalVisible, setIsRatingModalVisible] = useState(false);
    const [rating, setRating] = useState(0);
    const viewModel: ClientTripHistoryViewModel = container.resolve('driverTripRatingViewModel');
    ...
    const handleSendReport = async () => {
        if (reportText.trim()) {
            ...
            const response = await viewModel.updateDriverReport(clientRequestResponse.id, reportText);
    ...
    const handleSendRating = async () => {
        ...
        const response = await viewModel.updateDriverRating(clientRequestResponse.id, rating);
    ...
    const gotToChatScreen = () => {
        rootNavigation.navigate('ChatScreen', {
            comeFrom: 'ClientTripHistoryScreen',
                ...
                <View style={styles.clientInfo}>
                    ...
                    <View style={styles.clientDetails}>
                        ...
                        <Text style={styles.clientName}>
                            {clientRequestResponse.driver.name} {clientRequestResponse.driver.lastname}
                        </Text>
